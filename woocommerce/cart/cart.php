      ...
      <tbody>
         ...
         <tr>
            <td colspan="6" class="actions">
               ...
               <div class="flex flex-col gap-6 w-fit ml-auto justify-center max-w-full flex-wrap">
                  <?php if (wc_coupons_enabled())
                  { ?>
                     <div class="coupon w-[41.5rem] max-w-full">
                        <label for="coupon_code" class="screen-reader-text"><?php esc_html_e('Coupon:', 'woocommerce'); ?></label> <input type="text" name="coupon_code" class="input-text !w-[calc(100%-1rem-12.5rem)] h-[3.5rem]" id="coupon_code" value="" placeholder="<?php esc_attr_e('Coupon code', 'woocommerce'); ?>" /> <button type="submit" class="h-[3.5rem] !w-[12.5rem] max-w-full button<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>" name="apply_coupon" value="<?php esc_attr_e('Apply coupon', 'woocommerce'); ?>"><?php esc_html_e('Apply coupon', 'woocommerce'); ?></button>
                  ...
                  <div class="flex gap-6 w-full items-center">
                     ...
                     <div class="w-1/2 wc-proceed-to-checkout">
                        <a href="<?php echo $new_checkout_url; ?>" class="checkout-button button alt wc-forward h-[3.5rem] !mb-0 !py-0 !flex !items-center !justify-center !rounded-none !bg-[#841027]">
                           ...
                           <?php _e('Fechar compra', 'woocommerce'); ?>
